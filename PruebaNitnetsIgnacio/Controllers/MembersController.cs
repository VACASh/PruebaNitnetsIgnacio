...
namespace PruebaNitnetsIgnacio.Controllers
{
    ...
    public class MembersController : ControllerBase
    {
        ...
        // GET: api/Members
        [HttpGet("{numberPage}")]
        public IActionResult GetMembers( int numberPage)
        {
            if (MembersDac.GetAllMembers(numberPage).TotalItemCount > numberPage)
                return Ok(MembersDac.GetAllMembers(numberPage));
            else
                return BadRequest();
        }
